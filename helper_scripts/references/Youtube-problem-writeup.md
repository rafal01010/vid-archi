# Design a Video Streaming Platform Like YouTube | Hello Interview System Design in a Hurry
...
By[Evan King](https://www.linkedin.com/in/evan-king-40072280/)·Published Jul 10, 2024·
...
![Amazon](https://files.hellointerview.com/build-assets/PRODUCTION/_next/static/media/amazon-icon.5dc44df7.svg)
...
<iframe id="youtube-player-IUrQ5_g3XKs" style="width:100%;height:100%;pointer-events:auto" frameborder="0" allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" title="System Design Interview: Design YouTube w/ a Ex-Meta Staff Engineer" width="640" height="360" src="https://www.youtube.com/embed/IUrQ5_g3XKs?enablejsapi=1&amp;origin=https%3A%2F%2Fwww.hellointerview.com&amp;rel=0&amp;modestbranding=1&amp;disablekb=1&amp;start=0&amp;widgetid=1&amp;forigin=https%3A%2F%2Fwww.hellointerview.com%2Flearn%2Fsystem-design%2Fproblem-breakdowns%2Fyoutube&amp;aoriginsup=1&amp;gporigin=https%3A%2F%2Fwww.youtube.com%2F&amp;vf=1"></iframe>
...
[Learn This Pattern](/learn/system-design/patterns/large-blobs)

The design decision to upload directly to S3 means we have to change our POST /upload API to a POST /presigned\_url API. The server will create a presigned URL to enable the client to upload directly to S3. The request payload will just be the video metadata, vs. the metadata and the video file.
...
5.  When S3 acknowledges a part upload it returns the part number and an ETag. The client relays that response to the backend (e.g. PATCH /videos/{id}/chunks) so the server can verify the fingerprint/ETag via S3 APIs and then update the matching chunk record to Uploaded.
...
[Next: Web Crawler](/learn/system-design/problem-breakdowns/web-crawler)
...
[• 1 year ago](#comment-cm4risg8n00airpk7kfpi9cjr)
...
[• 1 year ago](#comment-cm4z1d1fc00cmwbx3q3rvlb7o)
...
[• 1 year ago](#comment-cm4a981ad00fjk9aczt3ssndl)

if we split into chunks on client

1.  how many presigned urls are created?
2.  how many s3 urls are created?
3.  do we merge these chunks into 1 video, and then split again into segments? or do we keep original chunks as segments
...
[• 1 year ago](#comment-cm6fzfnaq06tk6hpq1v46jxum)
...
chunk = binary data for upload purposes. useful for resumeable uploading and throughput segment = some part of a video that can be watched. useful for adaptive streaming
...
[• 1 year ago](#comment-cm5pxl5k301hk114y2hm0zi8s)
...
![Cosmos](https://lh3.googleusercontent.com/a/ACg8ocL8NnSLq197gvbE_3vzUschBcuml-h02t4Ztku4CbO_pdmmfkUE=s96-c)

Cosmos

[• 6 months ago](#comment-cme6cvr480rxbad08swbh0bh2)
...
![Abhimanyu Sharma](https://lh3.googleusercontent.com/a/ACg8ocKi6fkdDJ67UM3lGiQ37UY8KDkPHonbeb4M5OAb8zJ71tzxbpu3=s96-c)
...
[• 1 day ago](#comment-cmmbgrwke1m2u07ad0w4roshi)
...
[• 1 year ago](#comment-clyiz6fb90006k2zqk6abau07)
...
[• 1 year ago](#comment-clyiz856000063ivc6xofkuef)
...
[• 1 year ago](#comment-cm4nmrjte00nljs6st3d3l2r2)
...
![CTA](/_next/image?url=https%3A%2F%2Ffiles.hellointerview.com%2Fbuild-assets%2FPRODUCTION%2F_next%2Fstatic%2Fmedia%2Fcta.f3bd4b96.png&w=3840&q=75)
...
[About Us](/aboutus)[Product Support](mailto:support@hellointerview.com)
